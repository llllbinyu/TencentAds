...
def get_user_feature():
    ...
    user_feature=pd.read_csv('./data/userFeatureCompressed.csv')
    return user_feature
...
def batch_predict(data,index):
    one_hot_feature=['LBS','age','carrier','consumptionAbility','education','gender','os','ct','marriageStatus','advertiserId','campaignId', 'creativeId',
